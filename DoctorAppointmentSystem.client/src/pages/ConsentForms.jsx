...
const TEMPLATES = [
  {
    ...
    text: `I, the undersigned, consent to the examination and treatment recommended by the medical team. I understand that medicine is not an exact science and that satisfactory results cannot always be guaranteed.\n\nI acknowledge that I have been informed of the proposed treatment, its risks, benefits, and alternatives. I understand that I may withdraw this consent at any time.\n\nI confirm that all information I have provided regarding my health and medical history is accurate to the best of my knowledge.`
  },
  {
    title: 'Surgical Procedure Consent',
    text: `I consent to the surgical procedure as recommended by the doctor. I have been informed that the procedure is recommended based on my current medical condition.\n\nI understand the risks including but not limited to: pain and swelling, infection, bleeding, reaction to anesthesia, damage to surrounding structures, and the possibility of incomplete resolution.\n\nI agree to follow all pre-operative and post-operative instructions provided.`
  },
  {
    title: 'Minor Procedure Consent',
    text: `I consent to the minor procedure as outlined and recommended by my doctor. I understand the nature of the procedure and have had the opportunity to ask questions.\n\nI understand the risks including: discomfort, minor bleeding, infection, and the possibility that the procedure may not be fully successful, potentially requiring further treatment.\n\nI agree to follow all aftercare instructions provided by the medical team.`
  },
  {
    title: 'Diagnostic / Imaging Consent',
    text: `I consent to the diagnostic procedures and/or medical imaging (e.g., X-ray, ultrasound, blood work) as requested by my doctor for the purpose of diagnosis and treatment planning.\n\nI understand the purpose of these procedures and that results will be used to guide my care. I acknowledge any relevant risks such as minimal radiation exposure where applicable.`
  },
  {
    title: 'Photography / Documentation Consent',
    text: `I consent to photographs, medical imaging, and other clinical documentation being taken for the purpose of treatment planning, patient records, and potentially educational or research purposes (de-identified).\n\nI understand I may withdraw this consent at any time.`
  },
];
