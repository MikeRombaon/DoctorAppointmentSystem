...
dotnet ef migrations add AddWalkInSupportToAppointments --project DoctorAppointmentSystem.Data --startup-project DoctorAppointmentSystem.API

# Apply migration
dotnet ef database update --project DoctorAppointmentSystem.Data --startup-project DoctorAppointmentSystem.API
```
