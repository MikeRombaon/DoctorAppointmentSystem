...
const SLIDES = [
  { url: 'https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=1200&q=85', caption: 'Expert Dental Care' },
  { url: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?w=1200&q=85', caption: 'Modern Equipment' },
  { url: 'https://images.unsplash.com/photo-1588776814546-1ffbb0e769de?w=1200&q=85', caption: 'Precision Tools' },
  { url: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1200&q=85', caption: 'Compassionate Doctors' },
  { url: 'https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?w=1200&q=85', caption: 'Root Canal Therapy' },
  { url: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=1200&q=85', caption: 'Dental Restorations' },
  { url: 'https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=1200&q=85', caption: 'Tooth Extraction' },
  { url: 'https://images.unsplash.com/photo-1571772996211-2912bfe9f192?w=1200&q=85', caption: 'Dental Check-ups' },
];
    ...
    <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: BRAND.bg }}>
      ...
      {!isMobile && (
        ...
        >
          ...
          <Box sx={{
            position: 'absolute', inset: 0,
            background: `linear-gradient(160deg, rgba(26,107,74,0.88) 0%, rgba(19,77,53,0.92) 100%)`,
          }} />
          ...
          <Box sx={{ position: 'relative', zIndex: 1, width: '100%' }}>
            ...
            <Typography variant="h3" sx={{ color: '#fff', fontWeight: 700, lineHeight: 1.2, mb: 2 }}>
              Dental Clinic<br />Management
            </Typography>

            <Typography sx={{ color: 'rgba(255,255,255,0.7)', fontSize: '1rem', maxWidth: 320, mb: 6 }}>
              Streamlined operations for modern dental practices — scheduling,
              billing, clinical records, and patient care in one place.
            </Typography>

            {['Appointment Scheduling', 'Patient Records', 'Billing & Claims', 'Clinical Workflows'].map((f) => (
            ...
            >
              © {new Date().getFullYear()} Dental Clinic MS · Secure &amp; RBAC Protected
            </Typography>
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate>
            ...
            <Button
              ...
              sx={{
                ...
                boxShadow: '0 4px 14px rgba(26,107,74,0.35)',
                '&:hover': {
                  bgcolor: BRAND.primaryDark,
                  boxShadow: '0 6px 20px rgba(26,107,74,0.45)',
                },
